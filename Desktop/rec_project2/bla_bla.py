...
steps = [
    {"icon": "📊", "title": "Анализ данных", 
     "text": "Изучили распределение оценок, популярность курсов и активность пользователей"},
    ...
    {"icon": "🤖", "title": "Реализация моделей", 
     "text": "Разработали отдельно коллаборативную (SVD) и контентную (Doc2Vec) модели"},
    
    {"icon": "🔄", "title": "Интеграция подходов", 
     "text": "Создали гибридную систему: сначала SVD, потом дополнение рекомендациями Doc2Vec"},
    
    {"icon": "�", "title": "Оценка качества", 
     "text": "Сравнили метрики (Precision@10, Recall@10) с базовыми подходами"},
    
    {"icon": "📱", "title": "Визуализация", 
     "text": "Создали интерактивный интерфейс для тестирования рекомендаций"}
]
